...
<script>
  ...
  $('#box-product[data-id="<?php echo $product_id; ?>"] form[name="buy_now_form"]').on('input', function(e) {
    ...
    $(this).find('input[type="radio"]:checked, input[type="checkbox"]:checked').each(function(){
      if ($(this).data('price-adjust')) regular_price = ('=' === $(this).data('price-operator'))? $(this).data('price-adjust'): regular_price + $(this).data('price-adjust');
      if ($(this).data('price-adjust')) sales_price = ('=' === $(this).data('price-operator'))? $(this).data('price-adjust'): sales_price + $(this).data('price-adjust');
      if ($(this).data('tax-adjust')) tax = ('=' === $(this).data('price-operator'))? $(this).data('tax-adjust'): tax + $(this).data('tax-adjust');
    });
